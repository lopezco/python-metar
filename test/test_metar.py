...
class MetarTest(unittest.TestCase):
    def raisesParserError(self, code):
        self.assertRaises(Metar.ParserError, Metar.MetarRowParser, code)

    def test_010_parseType_default(self):
        """Check default value of the report type."""
        self.assertEqual(Metar.MetarRowParser("KEWR").type, "METAR")

    def test_011_parseType_legal(self):
        """Check parsing of the report type."""
        self.assertEqual(Metar.MetarRowParser("METAR").type, "METAR")
        self.assertEqual(Metar.MetarRowParser("SPECI").type, "SPECI")
        self.raisesParserError("TAF")

    def test_020_parseStation_legal(self):
        """Check parsing of the station code."""
        self.assertEqual(Metar.MetarRowParser("KEWR").station_id, "KEWR")
        self.assertEqual(Metar.MetarRowParser("METAR KEWR").station_id, "KEWR")
        self.assertEqual(Metar.MetarRowParser("BIX1").station_id, "BIX1")
        self.assertEqual(Metar.MetarRowParser("K256").station_id, "K256")
    ...
    def test_030_parseTime_legal(self):
        ...
        report = Metar.MetarRowParser("KEWR 101651Z")
    ...
    def test_031_parseTime_specify_year(self):
        ...
        report = Metar.MetarRowParser("KEWR 101651Z", year=other_year)
    ...
    def test_032_parseTime_specify_month(self):
        ...
        report = Metar.MetarRowParser("KEWR 101651Z", month=last_month)
    ...
    def test_033_parseTime_auto_month(self):
        ...
        if next_day > today.day:
            ...
            report = Metar.MetarRowParser("KEWR " + timestr)
    ...
    def test_034_parseTime_auto_year(self):
        ...
        report = Metar.MetarRowParser("KEWR 101651Z", month=next_month)
    ...
    def test_035_parseTime_suppress_auto_month(self):
        ...
        if next_day > today.day:
            ...
            timestr = "%02d1651Z" % (next_day)
            report = Metar.MetarRowParser("KEWR " + timestr, month=1)
            self.assertEqual(report.time.day, next_day)
    ...
    def test_040_parseModifier_default(self):
        ...
        self.assertEqual(Metar.MetarRowParser("KEWR").mod, "AUTO")

    def test_041_parseModifier(self):
        """Check parsing of 'modifier' groups."""
        self.assertEqual(Metar.MetarRowParser(sta_time + "AUTO").mod, "AUTO")
        self.assertEqual(Metar.MetarRowParser(sta_time + "COR").mod, "COR")
    ...
    def test_042_parseModifier_nonstd(self):
        ...
        def report(mod_group):
            ...
            return Metar.MetarRowParser(sta_time + mod_group)
    ...
    def test_140_parseWind(self):
        ...
        report = Metar.MetarRowParser(sta_time + "09010KT")
        ...
        report = Metar.MetarRowParser(sta_time + "09010MPS")
        self.assertEqual(report.wind_speed.value(), 10)
        ...
        report = Metar.MetarRowParser(sta_time + "VRB00KT")
        self.assertEqual(report.wind(), "calm")

        report = Metar.MetarRowParser(sta_time + "VRB03G40KT")
        self.assertEqual(report.wind_dir, None)
        self.assertEqual(report.wind_speed.value(), 3)
        ...
        report = Metar.MetarRowParser(sta_time + "21010G30KT")
        self.assertEqual(report.wind(), "SSW at 10 knots, gusting to 30 knots")

        report = Metar.MetarRowParser(sta_time + "21010KT 180V240")
    ...
    def test_141_parseWind_nonstd(self):
        ...
        def report(wind_group):
            ...
            return Metar.MetarRowParser(sta_time + wind_group)
    ...
    def test_150_parseVisibility(self):
        ...
        def report(vis_group):
            ...
            return Metar.MetarRowParser(sta_time + "09010KT " + vis_group)
    ...
    def test_290_ranway_state(self):
        ...
        def report(runway_state):
            ...
            return Metar.MetarRowParser(sample_metar + ' ' + runway_state)
    ...
    def test_300_parseTrend(self):
        ...
        def report(trend_group, remarks=""):
            ...
            return Metar.MetarRowParser(sample_metar + ' ' + trend_group + ' ' + remarks)
